...
public class ReminderUtilities {
    ...
    private static final String REMINDER_JOB_TAG = "life_saver_tag";
    ...
    synchronized public static void scheduleReminder(@NonNull final Context context) {
        ...
        Job ReminderJob = dispatcher.newJobBuilder()
                .setService(waterReminderJob.class)
                .setTag(REMINDER_JOB_TAG)
                .setLifetime(Lifetime.FOREVER)
                .setRecurring(true)
                .setTrigger(Trigger.executionWindow(
                     REMINDER_INTERVAL_SECONDS,SYNC_FLEXTIME_SECONDS+REMINDER_INTERVAL_SECONDS
                        ))
